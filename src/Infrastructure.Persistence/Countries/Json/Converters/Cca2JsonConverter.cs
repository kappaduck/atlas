...
internal sealed class Cca2JsonConverter : JsonConverter<Cca2>
{
    ...
    public override void Write(Utf8JsonWriter writer, Cca2 value, JsonSerializerOptions options) => throw new NotSupportedException($"{nameof(Cca2JsonConverter)} is only used for deserialization");
}
