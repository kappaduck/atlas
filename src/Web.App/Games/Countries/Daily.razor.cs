...
public sealed partial class Daily(ICountryService service, NavigationManager navigation, [FromKeyedServices(DailyCountryStorage.Key)] IDailyLocalStorage storage) : IDisposable
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        CountryResponse? country = await service.GetDailyCountryAsync(_cts.Token) ?? throw new InvalidOperationException();
    ...
    private void NavigateToRandom() => navigation.NavigateTo("/countries/random");
}
